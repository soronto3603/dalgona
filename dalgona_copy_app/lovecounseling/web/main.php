...
<body>
  ...
  <div id=header>
    ...
    <img id=header_dalgona src="img/img_logo_82x82.png" style='width: 60px;margin-top: 5px;'>
    <p id=header_title style='margin-left: 20px;'>연애상담소</p>
  ...
  <div id=menu>
    <center>
      ...
      <div class="line" style="height:80px">
        <img style="width:240px;" src="img/img_redbar_418x55.png">
        <h3 id=s_text>모든 사랑고민은 연애상담소에서 해결하세요1</h3>
      </div>
      <div class="line" onclick="move_page(1)">
        <img id=menu_image src="img/img_secret_688x212.png">
        <h1 id=line_text>
      ...
      <div class="line" onclick="move_page(2)">
        <img id=menu_image src="img/img_freetalk_688x212.png">
        <h1 id=line_text style='top:-75px'>
          <img width="16px" src="img/icon_freetalk_52x36.png">
          자유토크
        </h1>
      </div>
      <div class="line" onclick="move_page(3)">
        <img id=menu_image src="img/img_stranger_688x212.png">
        <h1 id=line_text>
      ...
      <div class="line" onclick="move_page(4)">
        <img id=menu_image src="img/img_popular_688x212.png">
        <h1 id=line_text>
