...
<body>
  ...
  <div id=header>
    ...
    <img id=header_dalgona src="img/img_logo_113x119.png" style='width: 50px;margin-top: 5px;'>
    <p id=header_title style='margin-left: 20px;'>연애고자</p>
  ...
  <div id=menu>
    <center>
      ...
      <div class="line" style="height:80px">
        <img style="width:240px;" src="img/img_yellowbar_418x55.png">
        <h3 id=s_text>바나나군처럼 고자가 될 수 없다! 본격 연애코칭 연애고자!</h3>
      </div>
      <div style='display:block'>
        <div onclick="move_page(1)">
          <img id=menu_image src="img/img_secret_338x412.png">
          <h1 id=line_text>
    ...
    bottom: 3px;'>
          <img id=menu_image src="img/img_freetalk_338x412.png">
          <h1 id=line_text>
      ...
      <div style='display:block;position:relative;bottom:40px;'>
        <div onclick="move_page(3)">
          <img id=menu_image src="img/img_stranger_338x412.png">
          <h1 id=line_text>
        ...
        <div onclick="move_page(4)">
          <img id=menu_image src="img/img_popular_338x412.png">
          <h1 id=line_text>
