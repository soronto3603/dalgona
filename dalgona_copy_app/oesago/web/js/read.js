...
function update_content(n){
  var json='{"title":"url","url":"http://total0808.cafe24.com/oesago/app/writing.php?id='+id+'&flag='+flag+'&read='+n+'"}';
  window.parent.postMessage(json,"*");
  if(id=='운영자'){
    window.open('http://total0808.cafe24.com/oesago/app/writing.php?id='+id+'&flag='+flag+'&read='+n);
  }
}
function delete_comment(n){
  ...
  $.post("delete_comment.php",{
    ...
    var json='{"title":"url","url":"http://total0808.cafe24.com/oesago/app/read.php?id='+id+'&flag='+flag+'&read='+read+'"}';
    window.parent.postMessage(json,"*");
    if(id=='운영자'){
      location.reload();
    }
