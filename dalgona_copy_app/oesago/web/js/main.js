...
function move_page(d){
  ...
  id=id.replace("?", "");
  if(d==1){
    var json='{"title":"url","url":"http://total0808.cafe24.com/oesago/app/talk_list_page.php?id='+id+'?&flag=0"}';
    window.parent.postMessage(json,"*");
  }else if(d==2){
    var json='{"title":"url","url":"http://total0808.cafe24.com/oesago/app/talk_list_page.php?id='+id+'?&flag=1"}';
    window.parent.postMessage(json,"*");
  }else if(d==3){
    var json='{"title":"url","url":"http://total0808.cafe24.com/random_chat/app/wait.php?phone_number='+id+'"}';
    window.parent.postMessage(json,"*");
  }else if(d==4){
    var json='{"title":"url","url":"http://total0808.cafe24.com/oesago/app/popular_hot.php?id='+id+'"}';
    window.parent.postMessage(json,"*");
  }else if(d==5){
...
function show_config(){
  id=document.getElementById('id').value;
  var json='{"title":"url","url":"http://total0808.cafe24.com/oesago/app/config.php?id='+id+'?&flag=2"}';
  window.parent.postMessage(json,"*");
}
function exit_app(){
