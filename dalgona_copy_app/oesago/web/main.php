...
<body>
  ...
  <div id=header>
    ...
    <img id=header_dalgona src="img/img_logo_182x76.png" style='width: 140px;margin-top: 5px;'>
    <p id=header_title style='margin-left: 90px;'>외사고</p>
  ...
  <div id=menu>
    <center>
      ...
      <div class="line" style="height:80px">
        <img style="width:240px;" src="img/img_purplebar_478x55.png">
        <h3 id=s_text>외사고에서 나만의 고민을 나누고 낯선사람과 대화 하세요!</h3>
      </div>
      <div style='display:block'>
        <div onclick="move_page(1)">
          <img id=menu_image src="img/img_secret_336x363.png">
          <h1 id=line_text>
    ...
    bottom: 3px;'>
          <img id=menu_image src="img/img_freetalk_336x363.png">
          <h1 id=line_text style='top: -107;'>
      ...
      <div style='display:block;position:relative;bottom:40px;'>
        <div onclick="move_page(3)">
          <img id=menu_image src="img/img_stranger_336x363.png">
          <h1 id=line_text>
        ...
        <div onclick="move_page(4)">
          <img id=menu_image src="img/img_hot_336x363.png">
          <h1 id=line_text>
