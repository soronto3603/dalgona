...
<body>
  ...
  <div id=header>
    ...
    <img id=header_dalgona src="img/img_logo_97x86.png" style='width: 70px;margin-top: 5px;'>
    <p id=header_title style='margin-left: 20px;'>익담소</p>
  ...
  <div id=menu>
    <center>
      ...
      <div class="line" style="height:80px">
        <img style="width:240px;" src="img/img_redbar_538x55.png">
        <h3 id=s_text>익담소에서 나만의 고민을 나누고 낯서사람과 대화 하세요!</h3>
      </div>
      <div style='display:block' >
        <div onclick="move_page(1)" style='position:relative;bottom:60px'>
          <img id=menu_image src="img/img_secret_339x374.png">
          <h1 id=line_text style='    top: -115;'>
    ...
    bottom: 3px;'>
      ...
      <div style='display:block;position:relative;bottom:40px;'>
        <div onclick="move_page(3)" style='position:relative;bottom:60px'>
          <img id=menu_image src="img/img_stranger_339x501.png">
          <h1 id=line_text style='    top: -150;'>
            <img width="16px" src="img/icon_strangertalk_35x35.png">
              낯선사람과의 대화
          </h1>
        </div>
        <div onclick="move_page(4)" style='position:relative;bottom:90px'>
          <img id=menu_image src="img/img_hot_339x384.png">
          <h1 id=line_text>
          </h1>
        </div>
      </div>
