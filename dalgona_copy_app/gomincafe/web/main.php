...
<body>
  ...
  <div id=header>
    ...
    <img id=header_dalgona src="img/img_logo_113x114.png" style='width: 60px;margin-top: 5px;'>
    <p id=header_title style='margin-left: 20px;'>고민카페</p>
  ...
  <div id=menu>
    <center>
      ...
      <div class="line" style="height:80px">
        <img style="width:240px;" src="img/img_bluebar_418x55.png">
        <h3 id=s_text>정말 답답하고 속상할 때 속 시원하게 고민을 털어놓으세요</h3>
      </div>
    ...
    bottom: 3px;'>
          <img id=menu_image src="img/img_freetalk_338x411.png">
          <h1 id=line_text>
      ...
      <div style='display:block;position:relative;bottom:40px;'>
        <div onclick="move_page(3)">
          <img id=menu_image src="img/img_stranger_338x411.png">
          <h1 id=line_text>
