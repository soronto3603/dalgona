...
function get_sim_info_suc(result){
  ...
  checkLoginStatus(function(e){
    ...
    if(e){
      ...
      document.getElementById('iframe').src="http://total0808.cafe24.com/21/app/main.php?id="+result.phoneNumber;
    }else{
      //alert('new');
      document.getElementById('iframe').src="http://total0808.cafe24.com/21/app/sign_up.php?phone_number="+result.phoneNumber;
    }
  });
}
...
function init_admob(){
  admob.interstitial.config({
   id: 'ca-app-pub-1542264535834690/2365579566',
 });
