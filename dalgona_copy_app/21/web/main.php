...
<body>
  ...
  <div id=header>
    ...
    <img id=header_dalgona src="img/img_logo_106x88.png" style='width: 70px;margin-top: 5px;'>
    <p id=header_title style='margin-left: 20px;'>둘이하나</p>
  ...
  <div id=menu>
    <center>
      ...
      <div class="line" style="height:80px">
        ...
        <h3 id=s_text>각종 연애고민상담을 통해 이제 둘이하나하세요!</h3>
      </div>
